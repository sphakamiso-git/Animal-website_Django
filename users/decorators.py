...
def user_not_authenticated(function=None, redirect_url='/'):
    ...
    the home page if necessary by default.
    """
...
def user_is_superuser(function=None,  redirect_url='/'):
    """
    Decorators for the views that checks that the user is superuser, redirecting to the
    homepage if necessary by default.
    """
    def decorator(view_func):
